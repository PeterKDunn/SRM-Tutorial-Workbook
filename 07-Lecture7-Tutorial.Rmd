...
* [Chapter 23 (Introducing inference)](https://bookdown.org/pkaldunn/SRM-Textbook/CIIntro.html).
* [Chapter 24 (Confidence intervals for one proportions)](https://bookdown.org/pkaldunn/SRM-Textbook/CIOneProportion.html).
* [Chapter 25 (Confidence intervals for one mean)](https://bookdown.org/pkaldunn/SRM-Textbook/OneMeanConfInterval.html).
* [Chapter 26 (More about forming CIs)](https://bookdown.org/pkaldunn/SRM-Textbook/AboutCIs.html).
* [Chapter 27 (Confidence intervals for mean differences (paired data))](https://bookdown.org/pkaldunn/SRM-Textbook/PairedCI.html).
...
include_graphics("Illustrations/corona-6278444_1920.jpg")
```
`r if (knitr::is_latex_output()) '-->'`
