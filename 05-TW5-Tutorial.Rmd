...
```{r StudentsNumSumChiA, echo=FALSE, fig.cap="A numerical summary from a student Project.", fig.align="center", out.width="100%"}
knitr::include_graphics("ProjectImages/NumericalSummaryChi2.png")
```
...
```{r StudentsGraphsChiB, echo=FALSE, fig.cap="A graph from a student Project.", fig.align="center", out.width='75%'}
knitr::include_graphics("ProjectImages/GraphicalSummaryChi2.png")
```
