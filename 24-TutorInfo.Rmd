...
### General comments on Mentis {.unlisted .unnumbered}
...
### Accessing Mentis {.unlisted .unnumbered}
...
### Using Mentis in tutorials {.unlisted .unnumbered}

*Display* the Mentis to the class  by:

- Going to the SCI110 Menti page (click the icon on the HMTL version).
...
```{r NumericalSummaryAns, echo=FALSE}
...
```{r, RulerDrop-jamovi, echo=FALSE, fig.cap = "Data entered in jamovi for the ruler-drop study", fig.align = "center", out.width='50%' }
knitr::include_graphics("SoftwareImages/RulerDropData.png")
```
