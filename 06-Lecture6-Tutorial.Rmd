...
## Random cards draws {#RandomCardDraws}
...
1. I did the same thing, but I repeated the process of tossing 10 coins 100 times.
...
```{r HistCoinToss, echo=FALSE, out.width='50%', fig.align="center", fig.cap='The histogram of the proportion of heads in 10 tosses, for 100 repetitions'}
set.seed(8412739)
