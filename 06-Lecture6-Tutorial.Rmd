...
if( knitr::is_html_output() ) {
  CoinData[ 1:10, 2] <- webexercises::fitb(num=TRUE, 
                                           tol = 0.001, 
                                           width = 6, 
                                           answer = "")
...
* Use this data to create a histogram.
  How would you describe the histogram?
* I did the same thing, but I repeated the process of tossinfg 10 coins 100 times.
  My histogram is shown in 
