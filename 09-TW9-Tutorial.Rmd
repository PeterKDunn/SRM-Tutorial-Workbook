...
```{r LimeTreesSummmary, echo=FALSE, fig.cap="jamovi output for comparing DBH (in cm) for two groups of lime trees,", fig.align="center", out.width="75%"}
knitr::include_graphics("SoftwareImages/LimeTreesSummary.png")
```
