...
\greyboxlines{4}
12. Do you think the population 2MWT changes because of the prosthetic, on average?
\greyboxlines{3}
13. Which of the following is the correct null hypothesis for this RQ? \tightlist
...
14. Write down the value of the $t$-statistic, then estimate the $P$-value for testing the hypotheses (using Fig.\ \@ref(fig:2MWTjamovi)).
\greyboxlines{3}
15. Explain why the $t$-score from jamovi is a negative value, but the $t$-score from SPSS (Fig.\ \@ref(fig:2MWTSPSS)) is a positive value.
\greyboxlines{2}
16. Write a statement that communicates the result of the test.
\greyboxlines{2}
17. What conditions must be met for this test to be valid?
\greyboxlines{2}
18. Is it reasonable to assume the assumptions are satisfied?
