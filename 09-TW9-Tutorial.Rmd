...
The researchers wanted to compare the mean DMFT for coeliacs and non-coaelics.
...
1. **FALSE**. The hypothesis is about a population parameter ($\mu$), which is good.  
   But the actual question was only aboyt studying the difference, which suggests a *two*-tailed alternative hypothesis (not a *one*-tailed alternative hypothesis as given).
