...
```{r LimeTreesSummmary, echo=FALSE, fig.cap="jamovi output for comparing DBH (in cm) for two groups of lime trees,", fig.align="center", out.width="100%"}
...
3. Suppose the $95$% CI for the difference was computed as\ $-2.7$ to\ $1.5$: very carefully interpret what this means.
4. Suppose the $95$% CI for the difference was computed as\ $0.6$ to\ $4.0$: very carefully interpret what this means.
5. Suppose the $95$% CI for the difference was computed as\ $-4.5$ to\ $-1.6)$: very carefully interpret what this means.
