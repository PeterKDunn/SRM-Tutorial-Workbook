...
`r if( knitr::is_html_output() ) {
   webexercises::mcq( c(answer ="10",
	  ...
	  "-16",
	  "16") )}`
1. True or false: A negative $z$-score means that the mean has a *smaller* value than the standard deviation.  
`r if( knitr::is_html_output() ) {webexercises::torf(FALSE) }`
1. True or false: A *standard error* measures the size of the difference between the sample proportion and the population proportion.   
`r if( knitr::is_html_output() ) {webexercises::torf(FALSE) }`
