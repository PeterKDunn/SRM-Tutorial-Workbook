...
```{r PizzaHistoCI, echo=FALSE, fig.cap="Histogram for the diameter of Eagle Boys' large pizzas. The corss is the claimed diameter of 12 inches.", fig.width=6, fig.height = 4}
data(PizzaSize)
