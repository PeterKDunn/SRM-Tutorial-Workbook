...
* [Chapter 38 (Correlation)](https://bookdown.org/pkaldunn/SRM-Textbook/Correlation.html).
...
2. Add some more points to the scatterplot such that the correlation is approximately $r = 0.7$.




## **Optional questions** {#OptionalTW11}
