...
* [Chapter 33 (Relationships between two quantitative variables)](https://bookdown.org/pkaldunn/SRM-Textbook/TwoQuant.html).
* [Chapter 34 (Correlations)](https://bookdown.org/pkaldunn/SRM-Textbook/Correlation.html).
* [Chapter 35 (Regression)](https://bookdown.org/pkaldunn/SRM-Textbook/Regression.html).
...
`r if( knitr::is_html_output() ) {
   webexercises::longmcq( c("The slope is 0.002", 
