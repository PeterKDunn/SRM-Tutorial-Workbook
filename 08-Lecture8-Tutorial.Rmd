...
* [Chapter 27 (Confidence intervals for two independent means)](https://bookdown.org/pkaldunn/SRM-Textbook/CITwoMeans.html).
* [Chapter 28 (Confidence intervals for comparing two odds or proportions)](https://bookdown.org/pkaldunn/SRM-Textbook/OddsRatiosCI.html).
* [Chapter 29 (Estimating sample sizes)](https://bookdown.org/pkaldunn/SRM-Textbook/EstimatingSampleSize.html)
...
## CIs for difference between two sample means {#CIRatLifetimes}
...
A large study [@data:duncan:maturity] studied 'the relationships between maturational timing and body image, school behavior, and deviance.'
...
Part of the data are shown entered into jamovi and SPSS (Fig.\ \@ref(fig:MaturationData-jamova-SPSS))
...
An Australian study [@data:luo:gm] decided to study:
