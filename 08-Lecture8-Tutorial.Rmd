...
1. The difference is computed as the number of DMFT for coeliacs minus non-coeliacs. True or false? \tightlist 
...
Some output from a sample of 125 of Eagle Boys' and Domino's large pizzas is shown in Fig. \@ref(fig:PizzaSizeComparejamovi) (jamovi)  and Fig. \@ref(fig:PizzaSizeCompare) (SPSS).
