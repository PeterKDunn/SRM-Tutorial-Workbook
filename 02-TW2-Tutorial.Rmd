...
`r if (knitr::is_latex_output()){
   'in Fig. \\@ref(fig:Crossword-Week2)'
} else {
   'below'
}`
...
4. Are the following variables likely to be extraneous variables, confounding variables, or neither? **Explain.**
...
6. Suggest the RQ asked at the start of the study by identifying POCI.
7. Is a cause-and-effect relationship reasonable? 
   Explain.
8. Read the extract from the original article below [@data:Murphy1998:homebirth]. 
   What is the sampling method? 
   Why are these limitations? 
   What other limitations of the study can you think of?
...
>
> --- @data:Murphy1998:homebirth, emphasis added


9. Based on this report, do you or do you not agree that (in general) a home birth is safer than a hospital birth? 
    Explain.
10. Is the article headline consistent with the study conclusions?
11. Is the last sentence of the quotation about internal validity, external validity, or ecoloical validity?
...
The map below of the UniSC Sippy Downs campus may prove helpful (where areas labelled **P** on the campus grounds are UniSC car parks).
