...
1. There ar emultiple stages of *random* selection, so this is multi-stage.
1. This is convenience sampling, since the researchers will only onbtain people who are there at the time the researchers are there (at their *convenience*).  
