...
* [Chapter 4 (Ethics in research)](https://bookdown.org/pkaldunn/SRM-Textbook/Ethics.html).
* [Chapter 5 (External validity: Sampling)](https://bookdown.org/pkaldunn/SRM-Textbook/Sampling.html).
* [Chapter 6 (Overview of internal validity)](https://bookdown.org/pkaldunn/SRM-Textbook/FactorsInfluenceY.html).
* [Chapter 7 (Internal validity and experimental studies)](https://bookdown.org/pkaldunn/SRM-Textbook/DesignExperiment.html).
* [Chapter 8 (Internal validity and observational studies)](https://bookdown.org/pkaldunn/SRM-Textbook/DesignObservational.html).
* [Chapter 9 (Identifying study limitations)](https://bookdown.org/pkaldunn/SRM-Textbook/Interpretation.html).
...
Consider this (qualitative) RQ: 'What factors are preventing the adoption of household solar technologies in Santiago [Chile]?' [@walters2018factors].
...
A student group was studying this RQ (which is **not** appropriate for the SCI110 Project): 'Among Australians, is the median serum cholesterol concentration different for smokers and non-smokers?'
...
7. "'*Whether or not the person's owns a cat*' is likely to be a confounding variable."
...
Read the description (line breaks added fo clarity) of one such study as shown below [@data:Lo2010:RobotAssistance], then complete the crossword 
`r if (knitr::is_latex_output()){
...
But how safe is home-birthing?
Consider the newspaper report shown in Fig. \@ref(fig:homebirths), based on a research article [@data:Murphy1998:homebirth].
...
1. Identify the outcome and response variable. \tightlist
...
5. *If the study is experimental*, determine if the principles of randomization, control, blinding and double-blinding, and blocking have been used.
	 Also, determine if it is a quasi-experiment or a true experiment.
6. *If the study is observational*, determine if the study uses a forward direction (*cohort study*), a backward direction (case-control study), or is non-directional (cross sectional).
...
> The results reported here reflect a sample of nurse--midwifery practices willing to participate in data collection and to permit the resulting scrutiny of their practices. 
> We cannot draw comparisons to non-participating nurse--midwifery practices or to the home birth practices of physician and other midwife providers.
>
...
`r if (knitr::is_latex_output()) '<!--'`
<iframe src='https://www.ferendum.com/en/embeded.php?pregunta_ID=458376&sec_digit=1584102666&embeded_digit=266427770' style='width:100%; height:450px; overflow: auto; background: #B3919133;' frameBorder='0'></iframe><BR>
<A href='https://www.ferendum.com' target='_blank'>Free Online Poll Maker</A>
`r if (knitr::is_latex_output()) '-->'`
<!-- Admin link: -->
...
Suppose we needed a sample of 80 vehicles parked at UniSC, and we wish to determine the proportion displaying P plates.

Determine a useful way to find a suitable representative sample.
The map below of the UniSC Sippy Downs campus may prove helpful (where areas labelled P are car parks).
