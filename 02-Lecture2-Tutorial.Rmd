...
1. Consider this (qualitative) RQ: "What factors are preventing the adoption of household solar technologies in Santiago [Chile]?" [@walters2018factors]. For this RQ, what is the *Population*?
...
3.  Suppose the researchers mailed surveys to all households in Santiago, and people who wished to returned the survey. What is the *best* description of this sampling method? 
`r if( knitr::is_html_output() ) {mcq( c(
