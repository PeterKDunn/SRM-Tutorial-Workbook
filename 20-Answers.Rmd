...
* No Exercises in the Break week.
...
5. An example RQ might be:  
   ...
   "Among UniSC students (P),
   is the average heart rate 30 minutes after drinking (O) different between those who drink a cup of Earl Grey tea and those who drinking a cup of hot coffee (C)
...
### Answers for Sect. \@ref(UnderstandingBoxplots) {.unlisted .unnumbered}
...
5. $\text{s.e.}(\hat{p}) = \sqrt{0.304455 \times (1-0.304455)/404} = \sqrt{0.00052416} = 0.022894$, or about 0.023.  
   ...
   Essentially, each sample is likely to produce a different value for the sample proportion, $\hat{p}$ (the estimate of the population proportion, $p$), 
   and that is what we mean by "sampling variation".
6. (Not provided.)
7. The values of $\hat{p}$ will have an approximate normal distribution,
...
13. Odds of *not* surviving in ETI group is $(306/110) = 2.8$,
...
* **Null hypothesis**: Spelling again; and the hypothesis should be explicitly comparing the *means*:
  "For weeping lilly pilly trees at UniSC,
