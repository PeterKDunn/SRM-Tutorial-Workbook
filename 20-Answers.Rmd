...
4. The *odds ratio* here means, from the RQ
$$
  \text{OR} = \frac{\text{Odds of bites, using citronella candle}}{\text{Odds of bites, using wax candle}}.
$$
  So the odds of someone receiving mosquito bites when sitting near a citronella candle is $0.41$ times the odds for those sitting near a wax candle (i.e., is lower).
5. $0.51\times 2.17 = 1.1$.
6. In the population, the odds of someone receiving mosquito bites when sitting near a citronella candle is between $0.23$ and $1.1$ times the odds for those sitting near a wax candle (i.e., is lower).
