...
* Answers for Teaching Week tutorial \@ref(Lecture1) (Teaching Week 1): Sect. \@ref(Lecture1Answers).
* Answers for Teaching Week tutorial \@ref(Lecture2) (Teaching Week 2): Sect. \@ref(Lecture2Answers).
* Answers for Teaching Week tutorial \@ref(Lecture3) (Teaching Week 3): Sect. \@ref(Lecture3Answers).
* Answers for Teaching Week tutorial \@ref(Lecture4) (Teaching Week 4): Sect. \@ref(Lecture4Answers).
* Answers for Teaching Week tutorial \@ref(Lecture5) (Teaching Week 5): Sect. \@ref(Lecture5Answers).
* Answers for Teaching Week tutorial \@ref(Lecture6) (Teaching Week 6): Sect. \@ref(Lecture6Answers).
* Answers for Teaching Week tutorial \@ref(Lecture7) (Teaching Week 7): Sect. \@ref(Lecture7Answers).
* No Exercises in the Break week.
* Answers for Teaching Week tutorial \@ref(Lecture8) (Teaching Week 8): Sect. \@ref(Lecture8Answers).
* Answers for Teaching Week tutorial \@ref(Lecture9) (Teaching Week 9): Sect. \@ref(Lecture9Answers).
* Answers for Teaching Week tutorial \@ref(Lecture10) (Teaching Week 10): Sect. \@ref(Lecture10Answers).
* Answers for Teaching Week tutorial \@ref(Lecture11) (Teaching Week 11): Sect. \@ref(Lecture11Answers).
...
## Answers for Teaching Week 1 tutorial {#Lecture1Answers}
...
## Answers for Teaching Week 2 tutorial {#Lecture2Answers}
...
3. *External validity* only refers to whether the *sample* represents the given *population*, which is *Australians*.
...
## Answers for Teaching Week 3 tutorial {#Lecture3Answers}
...
## Answers for Teaching Week 4 tutorial {#Lecture4Answers}
...
## Answers for Teaching Week 5 tutorial {#Lecture5Answers}
...
8. The $z$-score is 0.385 from [Table B.3](https://bookdown.org/pkaldunn/Book/ZTablesOnlineBackwards.html), remembering that the area to the *left* would be 0.650 (draw a diagram!). So, the $z$-score is 0.385, so that the SOI values is $x = \mu + (z\times\sigma) = 0 + (0.385\times 10) = 3.85$.





## Answers for Teaching Week 6 tutorial {#Lecture6Answers}
...
5. $\text{s.e.}(\hat{p}) = \sqrt{0.304455 \times (1-0.304455)/404} = \sqrt{0.00052416} = 0.022894$, or about 0.023.  
   A definition can be found in the [Glossary](https://bookdown.org/pkaldunn/Book/Glossary.html). 
...
8. One way of writing communicating: “The population proportion of patients surviving after BVM treatment has a 95% chance of lying between 26% and 35%.”
   This is not strictly correct, but acceptable and very, very commonly used (as explained in [the textbook](https://bookdown.org/pkaldunn/Book/CIInterpretation.html)).
...
15. A greater sample size would give a more precise estimate.
...
## Answers for Teaching Week 7 tutorial {#Lecture7Answers}
...
## Answers for Teaching Week 8 tutorial {#Lecture8Answers}




## Answers for Teaching Week 9 tutorial {#Lecture9Answers}
...
## Answers for Teaching Week 10 tutorial {#Lecture10Answers}
...
## Answers for Teaching Week 11 tutorial {#Lecture11Answers}
...
## Answers for Teaching Week 12 tutorial {#Lecture12Answers}
