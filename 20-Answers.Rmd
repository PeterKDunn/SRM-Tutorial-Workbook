...
1. Because the sex of the person is the explanatory variable.
1. (No answer.)
...
1. How much further patients with *with* the implant.
2. **Repeated-measures**:
...
11. Normal; mean $\mu$, std deviation is the standard error of $4.121$.
...
2. Sex is the explanatory variable.
