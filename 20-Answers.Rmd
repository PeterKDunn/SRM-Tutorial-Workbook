...
13. $H_0$: $\mu_d = 0$, differences defined as 'with' minus 'without'. 
    $H_1$: $\mu_d > 0$ the way I defined differences.  
14. $t = 6.041$ and since $t$ is very large, expect $P$ to be very small.
15. The differences have just been defined in the opposite directions.
   (Notice the $P$-values are the same.)
16. Very strong evidence exists in the sample (paired $t = 6.041$; one-tailed $P$ less than $0.0005$) that the population mean 2MWT are higher after receiving the implant compared to without the implant (mean difference: $24.9\ms$ higher after receiving the implant; standard deviation: $13.034\ms$; $95$%\ CI from $16.66$ to $33.14\ms$).
17. The population of differences has a normal distribution, and/or $n > 25$ or so.
18. Since $n < 25$, must assume the population of differences has a normal distribution.
...
5. Chi-squared: $5.84$; like $z = \sqrt{5.84/1} = 2.42$: large; $P$ about\ $0.016$.  

   The *sample* provides evidence to suggest that the odds of dying within five years is not the same between having a wearing an artificial limb and the five-year mortality rate *in the population* ($\text{chi-square} = 5.84$; $\text{df} = 1$; $P = 0.016$; OR: $2.771$ and $95$% CI from $1.198$ to\ $6.411$).
