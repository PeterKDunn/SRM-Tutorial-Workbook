...
2. Quasi-experimental. 
   The classes are determined by the *students*, but the lecturer decides which class gets which treatment.



### Answers for Sect. \@ref(TerminologyLect1) {.unlisted .unnumbered}

The answers, in no particular order, are: design; collect; quantitative; qualitative; data; ask; evidence.
...
relational; ethical; experimental; randomly; nominal; fire; sample; beach; help; control; blind.
...
1. C: Between blind and sighted individuals.
   Explanatory vhriable: Wwether the individual is blind, or not.
...
1. A few issues...
   * The vertical axis is not labelled.
     Presumably burn time in seconds.
   * The horizontal axis is not labelled.
     We have no way of knowing what is happening there.

2. A few issues...
    * This is not a *summary*: this shows the burn-time of every individual candle, and makes it hard to compare *means* (which is the RQ).
   * Why is every bar labelled?  
     That just adds unnecessary clutter.
   * Fonts are hard too read (small). 
   * A boxplot (or dotchart) would be the appropriate graph.
   * The largest value is over $70$\ mins! 
     Do a *quick* project!
...
### Answer for Sect. \@ref(HistogramBars) {.unlisted .unnumbered}
...
4. Report none based on five values!  
   Too few data points! 
   In any case, both the median and the mean have very similar values.
5. If all five measurements came from one board, we would not have a good representation of 'bamboo floorboards' in general.    
   We would have just *one unit of analysis*.
...
2. A few issues...
    * Five decimal places: That's accuracy to $0.00001$ of a millimetre per second.
      I don't think so...
...
2. Mean: $990.0791$, or $990.079$\ tonnes.
   Standard deviation: $1588.514579$, or $1588.5146$\ tonnes. 
...
2. Not sure which is best; they do different things.
...
1. **Plot\ 1**: $0.94$ (correlation\ **D**);  **Plot\ 2**: $-0.95$ (correlation\ **A**);\tightlist  
   **Plot\ 3**: $0.12$ (correlation\ **B**):  **Plot\ 6**: $0.75$ (correlation\ **C**).  
...
3. Examples of direction in **Plot\ 2**:
   Any two variables moderately negatively correlated, such as hours of weekly exercise and body weight, number of SCI110 tutorial missed and final mark, etc.
4. **Plot\ 1**: $88.4$%;  **Plot\ 2**: $90.3$%;  
   **Plot\ 3**: $1.4$%;  **Plot\ 6**: $56.3$%.
5. The answers:

    a. No answer. But a line is fine for **Plots\ 1, 2, 6** and **3** (but very weak!),  but not for **Plots\\ 4 and 6**. 
