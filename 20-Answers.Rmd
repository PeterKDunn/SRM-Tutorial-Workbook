...
**8.** The $z$-score is 0.385 from [Table B.3](https://bookdown.org/pkaldunn/Book/ZTablesOnlineBackwards.html), remembering that the area to the *left* would be 0.650 (draw a diagram!). So, the $z$-score is 0.385, so that te SOI values is $x = \mu + (z\times\sigma) = 0 + (0.385\times 10) = 3.85.
```   
