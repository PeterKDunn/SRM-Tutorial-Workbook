...
4. "Serum cholesterol" is not a variable; nothing here is varying. "Serum cholesterol" is just a type of cholesterol.  
   What actually varies from individual to individual--and so is the variable--is "the serum cholesterol concentration", or the "value of serum cholesterol".
5. This is *not an experiment*, since the individuals cannot be directed into the comparison groups (that is, to be a smoker or non-smoker) by the researchers. 
6. In the data file, each *row* is a *unit of analysis* (i.e., person) and each *column* is a variable. 
   So there will be *two variables* but not those listed: 
   one column will record the smoking status (as, perhaps, Yes/No) and one column will record the serum cholesterol concentration.
