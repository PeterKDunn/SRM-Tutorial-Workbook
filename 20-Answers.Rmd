...
The answers, in alphabetical order, are: ask; analysis; analyse; collect; data; definition; design; estimation; evidence; lurking; POCI; qualitative; quantitative; relational; unit.
...
5. Observational (cross-sectional/non-directional) study.
6. Possible RQ: "Among American mothers' births (P), is the neo-mortality rate (O) the same when giving birth at home compared to giving birth in hospital (C)?"
7. Cause-and-effect not reasonable (observational study).
...
9. This report doesn't suggest it is safer.
10. The headline is accurate, but is certainly **not the complete story** as it implies cause-and-effect.
