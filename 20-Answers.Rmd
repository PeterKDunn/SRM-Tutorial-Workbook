...
1. Mean: $168.5714$, or $168.57$\ m. 
   ...
   Median: $167.9$\ m.
   IQR: $175.0 - 162.5 = 12.5$\ m (software may give a different value).
2. Descriptive.
   $\bar{x} = 102.62$\ MPa; $s = 5.356$\ MPa.
...
2. $\bar{x} = 11.486$ inches; it's not sensible to quote the diameter to $0.001$ of a cm; what *would* be is sensible?
...
11. $24.9\pm (2\times 4.121623)$, or $24.9\pm 8.243246$, or from $16.65675$ to $33.143245$\ m.
...
8. $H_0$: $\mu_d = 0$, differences defined as 'after' minus 'before'. $H_1$: $\mu_d > 0$ the way I defined the differences.  
...
6. Slope of $0.311$: for each extra year of age, the stem diameter increases by about $0.311$\ mm on average.
...
**1.** P: school age children with ambulatory cerebral palsy; O: In this case, the hand-writing legibility;
       C: Between scores made when using standard and special furniture; I: The furniture configurations imposed.
