...
However, some parts explicitly mention and refer to [jamovi](https://www.jamovi.org/) [@Software:jamovi] and/or
[SPSS](https://www.ibm.com/products/spss-statistics) [@Software:SPSS] *output*.
...
This book was made using **R** [@Software:Rsoftware],
and the **bookdown** package [@Software:Rbookdown],
...
* The **kableExtra** package was used for nicer tables
  [@package:kableExtra].
* The map in Sect. \@ref(SamplingParking) (which is interactive in the online version) is made using the **leaflet** package [@package:leaflet].
...
* The **webexercises** package was used to create the interactive web exercises
  [@package:webex] (i.e., Quick Revision questions).
...
Peter K. Dunn (2022). *Scientific Research Methods: Tutorials*.
