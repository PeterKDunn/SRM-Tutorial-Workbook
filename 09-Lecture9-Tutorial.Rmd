...
`r if( knitr::is_html_output() ) {
   webexercises::torf( FALSE)}`
1. The *sampling distribution* shows how the values of the sample statistic are likely to vary from sample to sample (when the null hypothesis is true). True or false?  
`r if( knitr::is_html_output() ) {
   webexercises::torf( TRUE)}`
