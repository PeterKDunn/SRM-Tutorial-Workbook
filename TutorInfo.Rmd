...
* [Information](#Lecture8ThoughtsForTutors) for Teaching Week\ \@ref(Lecture8) Tutorial.
...
* **Course introduction**:
  Briefly introduce the course if necessary, but remember that I have instructed students to read the Course Outline and the Canvas information, and have emailed them lots of information too.
...
* **Approach**:
  Most SCI110 students are in their first year at UniSC, and everything is new!
...
* **Structure**:
  ...
  * Group them according to where they live: north-ish, west-ish, etc. (may be helpful for finding near-by group members).
    Then let them chat for a few minutes.
  * Line up by the average number of hours of paid work they expect to do per week.
    Again, lhen let them chat for a few minutes.
    Remind them that UniSC courses are designed for $8$--$10$ hours per week, including classes, every week; a lot of work is needed outside class times!
  * Ask them what they think the cost of SCI110 is (last I saw, $1\ 118 for domestic students; much higher for international (harder to pin down, but like $3\ 500).
    Remind them they don't have \$1000 to waste, so take advantage of all that we offer.
  * Then discuss the pre-semester fun survey (see below).
  * Then do some content questions.

Another activity that *may* be useful:

* Put up a list of all the expectations the students could have of themself (on time, prepared, when they don't know an answer, they'll find it for them next week, lesson plans to cover all content, giving students chances to respond etc)
* Break the class into groups, and have students write down what you should expect from them. 

Hopefully, the students start regulating that charter within their lessons...
...
* Ask them to guess the percentage of males or females in SCI110 *this* semester. 
  * Some will look at their class: is this a good guesstimate? 
  * Why or why not?
* Reveal that about $65$% of UniSC students are female. 
  * Does this change their guess?
* Then reveal the survey results for the last $10$ years or so.
...
I have prepared a H5P artefact for you to use:
...
Nonetheless, I think that learning to use a calculator for simple calculation is a useful skill.
Using the **Stats** mode can also be useful.

There *will* be a question in the exam where studets are expected to compute a mean and/or standard deviation, so finding a quick way (i.e., not by hand) is important.
...
Promote discussion, don't just give answers.
Ask **why**!
```
