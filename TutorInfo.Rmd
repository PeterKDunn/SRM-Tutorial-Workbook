...
One way to manage this: arrange students into groups, and have each group discuss Parts\ 1, 2 and\ 3 separately.
...
I know it is easier to measure reaction time using an app or website on a smartphone... but **I strongly suggest not doing so**.
The *purpose* of this activity is **not** getting the reaction times, but to think about planning a study.
Using the ruler drop as the activity allows a *lot* of opportunites to talk about many of the issues in study design and data collectionm which **is** the purpose of this activty.
...
This means that the need for students to use a calculator is diminished; they can use whatever they want (e.g., spreadhseet) I guess. 
...
### Thoughts on Sect. \@ref(QuickRevision-Tutorial4) {.unlisted .unnumbered}
...
If students use the wrong standard deviation button, they will get $\sigma = 4.79$\ MPa in error.
...
```{block2, type="rmdTutorInfo"}
If you wish, you can form a CI for the ruler-drop (using jamovi).
