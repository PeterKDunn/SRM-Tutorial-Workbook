...
* [Chapter 34 (Tests for the means of two independent groups)](https://bookdown.org/pkaldunn/SRM-Textbook/TestTwoMeans.html).
* [Chapter 35 (Tests for comparing two odds or proportions)](https://bookdown.org/pkaldunn/SRM-Textbook/TestsOddsRatio.html).
* [Chapter 36 (Selecting a hypothesis test)](https://bookdown.org/pkaldunn/SRM-Textbook/SelectTest.html).
...
if( knitr::is_html_output() ) {
  ...
  ArtLimbSumm[3, 1] <- webexercises::fitb(num = TRUE, 
                                          tol = 0.005, 
                                          width = 6, 
                                          answer = 22.9 )
  ArtLimbSumm[3, 2] <- webexercises::fitb(num = TRUE, 
                                          tol = 0.005, 
                                          width = 6, 
                                          answer = 2.771 )
