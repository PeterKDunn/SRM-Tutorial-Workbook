...
A study compared the arrivals-on-scene for two groups of paramedics [@tuttle2018paramedic]:
...
1. Since the two sample means are different, there is no evidence to support the null hypothesis. True or false?
`r if( knitr::is_html_output() ) { torf(FALSE) }`
