...
* [Chapter 32 (Tests for the means of two independent groups)](https://bookdown.org/pkaldunn/SRM-Textbook/TestTwoMeans.html).
* [Chapter 33 (Tests for odds ratios)](https://bookdown.org/pkaldunn/SRM-Textbook/TestsOddsRatio.html).
* [Chapter 34 (Selecting a hypothesis test)](https://bookdown.org/pkaldunn/SRM-Textbook/SelectTest.html).
...
1. The *null* hypothesis is $H_0$: $\mu_{IE} = \mu_{E}$.\tightlist True or false?  
...
1. Write the hypotheses for testing the research question of interest. Is the test one- or two-tailed? \tightlist
