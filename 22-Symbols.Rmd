...
* When the sampling distribution is approximately normally distributed, under appropriate statistical validity conditions, this is indicated by\ `r ifelse( knitr::is_latex_output(), "\\ding{52}", "&#10004;")`.
...
```{r ParametersStatistics2, echo=FALSE}
...
if( knitr::is_latex_output() ) {
  colnames(SymbolsTab) <- c("abbreviation", 
                            "Meaning", 
                            "reference")
  ...
  kable( SymbolsTab,
    ...
    add_header_above( c("Symbol or" = 1,
                        " " = 1,
                        "Textbook" = 1),
                      bold = TRUE,
                      line = FALSE)
