...
```{r MosquitoBitesjamovi, echo=FALSE, fig.cap="Mosquito bites when near different types of candles.", fig.align="center", out.width="80%"}
knitr::include_graphics("SoftwareImages/MosquitoBites.png")
```
