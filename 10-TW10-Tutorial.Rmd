...
```{r MosquitoBitesjamovi, echo=FALSE, fig.cap="Mosquito bites when near different types of candles.", fig.align="center", out.width="75%"}
...
```{r BoysMaturejamovi, echo=FALSE, fig.cap="The jamovi output from the maturation study", fig.align="center", out.width="55%"}
