...
* [Chapter 29 (Making decisions)](https://peterkdunn.github.io/SRM-Textbook/MakingDecisions.html).
* [Chapter 20 (Sampling variation)](https://peterkdunn.github.io/SRM-Textbook/SamplingVariation.html).
* [Chapter 21 (Models and normal distributions)](https://peterkdunn.github.io/SRM-Textbook/SamplingDistributions.html).
...
`r if (knitr::is_html_output()){
   'Appendices \\@ref(ZTablesOnline)\\ and \\@ref(ZTablesOnlineBackwards)).'
} else {
   'Appendices \\@ref(ZTablesNEG), \\@ref(ZTablesPOS) and \\@ref(ZTablesOnlineBackwards)).'
}`
:::
