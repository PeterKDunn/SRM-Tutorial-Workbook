...
* [Chapter 22 (Introducing inference)](https://peterkdunn.github.io/SRM-Textbook/IntroducingInference.html).
* [Chapter 23 (Confidence intervals for one proportions)](https://peterkdunn.github.io/SRM-Textbook/CIOneProportion.html).
* [Chapter 24 (Confidence intervals for one mean)](https://peterkdunn.github.io/SRM-Textbook/OneMeanConfInterval.html).
* [Chapter 25 (More about forming CIs)](https://peterkdunn.github.io/SRM-Textbook/AboutCIs.html).
* [Chapter 26 (Confidence intervals for mean differences (paired data))](https://peterkdunn.github.io/SRM-Textbook/PairedCI.html).
...
A study examined the use of ETI for airway management of children in the out-of-hospital setting [@data:Gausche200:Endotracheal].
...
4. In another sample of $404$ patients who received the BVM treatment, would we expect to find *exactly* $123$ surviving?
   Why or why not?
5. Compute the *standard error*, which indicates the sampling variability in the estimate of $p$.
...
10. If the researchers wished to estimate the true survival proportion to within give-or-take $0.01$ with $95$% confidence, would the sample size need to be *larger* or *smaller*?
11. For the ETI sample, $110$ out of $416$ patients survived.
    Use this information to construct a two-way table of treatment against survival.
12. Select a graphical summary that could be used to display the information.
    Sketch this display.
13. From this table, compute the odds ratio of a BVM patient *not* surviving compared to an ETI patient *not* surviving.
    Interpret this value.
14. What did you learn about using ETI on children?
...
A summary of the diameters of a sample of $125$ of Eagle Boys' large pizzas is shown in Fig.\ \@ref(fig:PizzaCIjamovi) (jamovi) and Fig.\ \@ref(fig:PizzaCISPSS) (SPSS).
...
```{r PizzaHistoCI, echo=FALSE, fig.cap="Histogram for the diameter of Eagle Boys' large pizzas", fig.width=6, fig.height = 4}
...
The data were entered into software, producing the output in Fig. \@ref(fig:LengthsHallOutputjamovi1) (jamovi) and Fig. \@ref(fig:LengthsHallOutput) (SPSS).
...
3. Write down the $95$% CI for the population estimate (see Fig.\
\@ref(fig:LengthsHallOutputjamovi1) (jamovi) or Fig.\ \@ref(fig:LengthsHallOutput) (SPSS)).
...
1. What type of research question is being answered: descriptive, relational, repeated-measures of correlational? 
   Explain.
...
Two different mooring types were compared (Table\ \@ref(tab:mooringCI)) in $18$ different sea states.
