...
```{r PizzaHistoHT, echo=FALSE, fig.cap="Histogram for the diameter of Eagle Boys' large pizzas. The cross represents the claimed diametet of $12$ inches.", fig.align="center", fig.width=6, fig.height=3.5, out.width="70%"}
data(PizzaSize)
