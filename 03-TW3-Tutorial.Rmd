...
AISTab[1, ] <- Hts
AIScap <- "The heights (in centimetres) of female tennis players at the AIS."
...
1. `r if( knitr::is_latex_output() ) {'Is the type of research study a true experimental, quasi-experimental, or observational study? Justify your answer.'} else {'The type of research study is  '}`
`r if( knitr::is_html_output() ) {webexercises::longmcq( c("a true experimental.", "a quasi-experimental study.",	answer= "an observational study."))}`\tightlist
\greyboxlines{2}
