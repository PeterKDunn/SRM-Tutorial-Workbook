...
```{r FourHistograms, echo=FALSE, fig.cap="Four histograms; what \\textbf{shape} is appropriate for which scenario?", fig.align="center", out.width='55%', fig.width=5.5, fig.height=5.5, out.width="80%"}
