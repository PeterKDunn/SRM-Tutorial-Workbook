...
```{r FourHistograms, echo=FALSE, fig.cap="Four histograms; what \\textbf{shape} is appropriate for which scenario?", fig.align="center", out.width='55%', fig.width=6.5, fig.height=5.5, out.width="80%"}
...
par(mfrow = c(2, 2),
    mgp = c(1.5, 0, 0)) # DEFAULT: c(3, 1, 0): reduce gap between x-lab and plot
   hist(xA,
        main = "Graph A",
        xlab = "Variable",
        ylab = "Frequency",
