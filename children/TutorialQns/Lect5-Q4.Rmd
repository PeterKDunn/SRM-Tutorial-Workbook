...
using words and phrases from Table \@ref(tab:Words1Table).
...
```{r DecisionFlowBlanks, echo=FALSE, fig.cap="A way to make decisions for the cards example", fig.align="center", fig.width=6.5, fig.height=3, out.width="85%"}
...
> * My _____ would be that the proportion of odd numbers is 0.5. This value is a ______.
