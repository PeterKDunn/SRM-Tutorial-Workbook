...
```{r, echo=FALSE}
htmltools::tags$video(src ="./Movies/HaveZFindArea.m4v", width="500", autoplay="autoplay", controls="controls", loop="loop", style="padding:5px;border-top:2px gray;border-bottom:2px gray;")
```
...
```{r, echo=FALSE}
htmltools::tags$video(src ="./Movies/HaveZFindAreaHardcopy.m4v", width="400", autoplay="autoplay", controls="controls", loop="loop", style="padding:2px;border-top:1px gray;border-bottom:1px gray;")
```
