# Teaching Week 12: Tutorial  {#Lecture11}
...
* [Chapter 36 (Reading research)](https://bookdown.org/pkaldunn/Book/Reading.html).
* [Chapter 37 (Writing research)](https://bookdown.org/pkaldunn/Book/WritingResearch.html).
...
In a study of high strength--high ductile concrete [@data:Ranada2015:Concrete],
the researchers measured (among other things) the load required to create the first visible cracks
in concrete samples under various strains rates.

Under a strain rate of 10&nbsp;s${}^{-1}$,
the $n=6$ concrete samples produced a **mean** first-crack strength of 12.4&nbsp;MPa with a **standard deviation** of 2.8&nbsp;MPa.

One     student computes the approximate 95% CI for the mean first-crack strength as $12.4\pm 2.8$&nbsp;MPa.

Another student computes the approximate 95% CI for the mean first-crack strength as $12.4\pm (2\times 2.8)$, 
or from $6.8$ to $18.0$&nbsp;MPa. 
...
Critique these extracts, 
and suggest better ways of communicating the information.
...
* **Results (1)**:
		  The 95\% CI for the difference in distance in metres 
		  (wooden verse iron) differes from
		  34.74 -- 43.25 further for shots with the Iron
* **Results (2)**:
	    Very strong evidence exists in the paired sample 
			(paired $t=18.406$; $n = 50$; two tailed; $P = 0.000$) of a population mean difference 
			between the wooden and iron golf clubs...
...
* **Null hypothesis**:
      Among current USC students studying SCI110, male and female resting heart rates are the same.
* **Results**:
...
* **Methods**:
			   ...
			   The 4th leaf on the branch will be chosen 5 times on each side of the tree
...
* **Research question**:
		    Among USC Sippy Downs students, 
			  are individuals who regularly play sports have closer estimations to the actual measurement when identifying 
			  the width of a regular path compared to individuals who don't play sports regularly?
* **Null hypothesis**:
		    The Null Hypophysis for our research question is that students 
			  who play sports regularly at the USC Sippy down campus have an increased level of perception 
			  when it comes to estimating distances.
* **Results**:
		   This sample presents strong evidence in support of the Null Hypothesis that sport status 
			 has an affect on distance estimation (regular played sport: mean 176.36 and non regular played sport: mean 172.34).

* **Discussion**:
		    From our original research question we have concluded that it supports the 
			  Null Hypothesis as it has a large P-value (0.36: one-tailed). Therefore we have proven that playing sports regularly has an effect on the accuracy of distance estimation.
...
A study examined the mortality rates within five years of lower-limb amputation,
...
*(Answers available in Sect. \@ref(Lecture11Answers))*

Mastering handwriting is an important skill for children to learn,
but children with cerebral palsy have a higher prevalence of handwriting problems.

One study [@data:Ryan:CerebralPalsy]
examined the effect
of handwriting legibility of children with cerebral palsy
using two different types of configuration of the school desks
('standard' or 'speciality').

Each of the 30 students 
(aged 6 to 8 years old) 
used both desks.
Legibility (and other aspects of handwriting)
was assessed using the quantitative Minnesota Handwriting Assessment (MHA) scale.

Part of Table 1 in the paper is shown in
Fig. \@ref(fig:Ryan2010Table1).
...
1. Read the extract in Fig. \@ref(fig:Ryan2010Aims). Determine P, O, C and I (where possible) for this study.
2. Identify the type of study being used. Is this a paired design or not?  Explain.
...
4. Identify the units of observation and units of analysis.
5. Does the study use blinding? If so, for what reason?  If not, why not?  
...
1. Identify the possible research question being answered, identifying (where possible) P, O, C and I.
2. Identify the type of question is being asked: Descriptive, Relational or Interventional   
