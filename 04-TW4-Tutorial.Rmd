...
```{r SoccerGraph, echo=FALSE, fig.cap="Four different graphs displaying the soccer-data. 'S' mean a soccer player; 'NS' means a non-soccer athlete; 'NA' means a non-athlete.", fig.height=7.5, fig.width=5.5, out.width="75%", fig.align="center"}
