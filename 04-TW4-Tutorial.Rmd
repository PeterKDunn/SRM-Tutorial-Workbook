...
* Numerical summaries for **qualitative** data (e.g., odds).
* Graphical summaries for comparing **qualitative** data.
* Numerical summaries for comparing **qualitative** data (e.g., odds ratios).
:::
...
* The student type:
one of 'soccer player', 'non-soccer athlete', or 'non-athlete'.
* The number of head concussions:
each student was asked about the number of head concussions they had experienced; 'zero' , 'one', or 'two or more' concussions.
