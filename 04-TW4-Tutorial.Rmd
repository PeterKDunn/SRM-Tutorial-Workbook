...
StrokeSumm[3, 1] <- "Difference:"
StrokeSumm[3, 2] <- "Odds ratio:"
StrokeSumm[3, 3] <- " "

if( knitr::is_latex_output() ) {
  
  StrokeSumm[3, 1] <- cell_spec( StrokeSumm[3, 1], 
                                 format = "latex",
                                 align = "l")
  StrokeSumm[3, 2] <- cell_spec( StrokeSumm[3, 2], 
                                 format = "latex",
                                 align = "l")
    kable(StrokeSumm,
          format = "latex",
...
if( knitr::is_html_output() ) {
  ...
  StrokeSumm[2, 1] <- webexercises::fitb(num = TRUE, 
                                         tol = 0.2, 
                                         width = 6,
  ...
  StrokeSumm[2, 2] <- webexercises::fitb(num = TRUE, 
                                         tol = 0.02, 
                                         width = 6, 
  ...
  StrokeSumm[1, 3] <- webexercises::fitb(num = TRUE, 
                                         ...
                                         width = 6, 
                                         answer = 43 + 67 )
  StrokeSumm[2, 3] <- webexercises::fitb(num = TRUE, 
                                         tol = NULL, 
                                         width = 6, 
                                         answer = 97 + 39 )
