...
1. Which opf these would be an **inappropriate** numerical summary for the age of the participants? \tightlist  
...
if( knitr::is_html_output() ) {
  StrokeSumm[1, 1] <- webexercises::fitb(num = TRUE, 
                                         tol = 0.002, 
                                         width = 6, 
                                         answer = round(43 / (43 + 67)) )
  StrokeSumm[3, 1] <- webexercises::fitb(num = TRUE, 
                                         tol = 0.002, 
                                         width = 6,
                                         answer = round(39 / (39 + 97)) )
