...
```{r OSAoutput, echo=FALSE, fig.cap="A numerical summary of the OSA data: jamovi", fig.align="center", out.width='75%'}
knitr::include_graphics("SoftwareImages/OSADescriptive.png")
```
