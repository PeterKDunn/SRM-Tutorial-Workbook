...
{
  'Part of the data are shown in Table\\ \\@ref(tab:OSAKable3).'
}
`
...
```{r OSADT3, echo=FALSE, fig.cap="The Obstructive sleep apnoea data set", fig.align="center"}
