...
if( knitr::is_html_output() ) {
  StrokeSumm[1, 1] <- webexercises::fitb(num = TRUE, 
                                         tol = 0.2, 
                                         width = 6, 
                                         answer = round(43 / (43 + 67) * 100) )
  StrokeSumm[3, 1] <- webexercises::fitb(num = TRUE, 
                                         tol = 0.2, 
                                         width = 6,
                                         answer = round(39 / (39 + 97) * 100) )
  ...
  kable(StrokeSumm[ c(1, 3, 5), ],
        ...
        escape = FALSE,
        longtable = FALSE,
        caption = "Summary table: emergency dispatchers and missing stroke symptoms. Enter PERCENTAGES as WHOLE NUMBERS. Enter ODDS to TWO decimal places.",
        booktabs = TRUE)  %>%
    add_header_above( c(" " = 1,
                        "Percentage" = 1,
                        "Odds" = 1,
...
Why?
4. Among the **non-athletes**, compute the odds of receiving two or more concussions.
Interpret what this means.
5. Among the **soccer players**, compute the odds of receiving two or more concussions.
Interpret what this means.
