...
<!-- ```{r VariationHistograms, echo=FALSE, fig.cap="Four histograms: which has the largest variation? The largest average? Every class has the same number of students.", fig.height=6, fig.width=5} -->
...
<!-- par( mfrow=c(2,2), mar=c(10,4,2,2) + 0.1) -->
...
1. Critique the numerical summary in 
	 Fig. \@ref(fig:StudentsNumSumA),
...
## Numerical summary for ruler-drop data {#PlanStudy3}
