...
* [Chapter 13 (Numerical summaries: quantitative data)](https://bookdown.org/pkaldunn/SRM-Textbook/NumericalQuant.html).
* [Chapter 14 (Numerical summaries: qualitative data)](https://bookdown.org/pkaldunn/SRM-Textbook/NumericalQual.html).
...
If you get $s=4.790157$ for the *standard deviation*, you are using your calculator incorrectly, so please **ask for help**.
...
In this activity, you get to critique actual Project submissions, so you can critique your own *before* submission.
