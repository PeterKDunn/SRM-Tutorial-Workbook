...
* [Chapter 11 (Describing data)](https://bookdown.org/pkaldunn/Book/DescribingVars.html).
* [Chapter 12 (Graphical summaries of data)](https://bookdown.org/pkaldunn/Book/Graphs.html).
...
3. Critique the graph in
	 Fig. \@ref(fig:StudentsGraphsC),
	 a screenshot from a student Project Report
...
4. Do you think that a real difference exists between plant coverage at different locations around the ant nest? What other interesting features can be seen from the graph?
...
5. Do you think that a real difference exists between the two treatments *in the population*? Explain
