...
In @data:heartbear:radziun2023:

* P : ??
* O : The accuracy of counting heartbeats (measure using Interoceptive Accuracy, which is on a scale of 0 to 1 (perfect)) averaged across their answers to counting heartbeats over 25, 30, 35, 40, 45, and 50 seconds.
* C: Between blind ($n = 34$) and sighted ($n = 36$) individuals
* I: Yes or no??
...
* $y$: accuracy: quantitative
* $x$: blind (yes or no): qualitative with two levels
* Graph: boxplot
* Units of a and o: People
