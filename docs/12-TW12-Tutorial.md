...
<div class='webex-radiogroup' id='radio_OVUGGJKDBL'><label><input type="radio" autocomplete="off" name="radio_OVUGGJKDBL" value=""></input> <span>The number of seeds</span></label><label><input type="radio" autocomplete="off" name="radio_OVUGGJKDBL" value="answer"></input> <span>The grams of mud</span></label><label><input type="radio" autocomplete="off" name="radio_OVUGGJKDBL" value=""></input> <span>The season</span></label></div>

\greyboxlines{1}
2. In this study, what variable would be the $y$-variable?
<div class='webex-radiogroup' id='radio_GABMGVZIOI'><label><input type="radio" autocomplete="off" name="radio_GABMGVZIOI" value="answer"></input> <span>The number of seeds</span></label><label><input type="radio" autocomplete="off" name="radio_GABMGVZIOI" value=""></input> <span>The grams of mud</span></label><label><input type="radio" autocomplete="off" name="radio_GABMGVZIOI" value=""></input> <span>The season</span></label></div>

\greyboxlines{1}
3. What is the value of $R^2$?
<div class='webex-radiogroup' id='radio_QPWWGBGADH'><label><input type="radio" autocomplete="off" name="radio_QPWWGBGADH" value="answer"></input> <span>86.7%</span></label><label><input type="radio" autocomplete="off" name="radio_QPWWGBGADH" value=""></input> <span>93.1%</span></label><label><input type="radio" autocomplete="off" name="radio_QPWWGBGADH" value=""></input> <span>96.5%</span></label></div>
...
<div class='webex-radiogroup' id='radio_WIGHQGVFAB'><label><input type="radio" autocomplete="off" name="radio_WIGHQGVFAB" value="answer"></input> <span>380</span></label><label><input type="radio" autocomplete="off" name="radio_WIGHQGVFAB" value=""></input> <span>96422</span></label><label><input type="radio" autocomplete="off" name="radio_WIGHQGVFAB" value=""></input> <span>-104</span></label></div>

\greyboxlines{2}
5. In this regression equation, the slope means:
<div class='webex-radiogroup' id='radio_OSRUODCPPD'><label><input type="radio" autocomplete="off" name="radio_OSRUODCPPD" value=""></input> <span>Each seed is associated with 137.4 extra grams of mud on average</span></label><label><input type="radio" autocomplete="off" name="radio_OSRUODCPPD" value=""></input> <span>Each seed is associated with 0.3459 extra grams of mud on average</span></label><label><input type="radio" autocomplete="off" name="radio_OSRUODCPPD" value=""></input> <span>Each 1g of mud is associated with 137.4 extra seeds on average</span></label><label><input type="radio" autocomplete="off" name="radio_OSRUODCPPD" value="answer"></input> <span>Each 1g of mud is associated with 0.3459 extra seeds on average</span></label></div>

\greyboxlines{2}
6. The $P$-value for the regression slope was $0.002$. 
   What does this mean?
<div class='webex-radiogroup' id='radio_AUXARMHQFW'><label><input type="radio" autocomplete="off" name="radio_AUXARMHQFW" value=""></input> <span>The slope is 0.002</span></label><label><input type="radio" autocomplete="off" name="radio_AUXARMHQFW" value="answer"></input> <span>The slope is unlikely to be non-zero simply by chance</span></label><label><input type="radio" autocomplete="off" name="radio_AUXARMHQFW" value=""></input> <span>There is evidence that the mean number of seeds is different than the mean grams of mud</span></label></div>
