...
<div class='webex-radiogroup' id='radio_XJVCHKQWVV'><label><input type="radio" autocomplete="off" name="radio_XJVCHKQWVV" value=""></input> <span>Quantitative: discrete</span></label><label><input type="radio" autocomplete="off" name="radio_XJVCHKQWVV" value="answer"></input> <span>Quantitative: continuous</span></label><label><input type="radio" autocomplete="off" name="radio_XJVCHKQWVV" value=""></input> <span>Qualitative: nominal</span></label><label><input type="radio" autocomplete="off" name="radio_XJVCHKQWVV" value=""></input> <span>Qualitative: ordinal</span></label></div>

\greyboxlines{1}
2. How would you *classify* the variable `Gender`? \tightlist
<div class='webex-radiogroup' id='radio_BCXCKWSFYI'><label><input type="radio" autocomplete="off" name="radio_BCXCKWSFYI" value=""></input> <span>Quantitative: discrete</span></label><label><input type="radio" autocomplete="off" name="radio_BCXCKWSFYI" value=""></input> <span>Quantitative: continuous</span></label><label><input type="radio" autocomplete="off" name="radio_BCXCKWSFYI" value="answer"></input> <span>Qualitative: nominal</span></label><label><input type="radio" autocomplete="off" name="radio_BCXCKWSFYI" value=""></input> <span>Qualitative: ordinal</span></label></div>

\greyboxlines{1}
3. How would you *classify* the variable `BMI`? \tightlist
<div class='webex-radiogroup' id='radio_JVUZEYUYVV'><label><input type="radio" autocomplete="off" name="radio_JVUZEYUYVV" value=""></input> <span>Quantitative: discrete</span></label><label><input type="radio" autocomplete="off" name="radio_JVUZEYUYVV" value="answer"></input> <span>Quantitative: continuous</span></label><label><input type="radio" autocomplete="off" name="radio_JVUZEYUYVV" value=""></input> <span>Qualitative: nominal</span></label><label><input type="radio" autocomplete="off" name="radio_JVUZEYUYVV" value=""></input> <span>Qualitative: ordinal</span></label></div>

\greyboxlines{1}
4. How would you *classify* the variable `REI`? \tightlist
<div class='webex-radiogroup' id='radio_DYNIONZCWW'><label><input type="radio" autocomplete="off" name="radio_DYNIONZCWW" value=""></input> <span>Quantitative: discrete</span></label><label><input type="radio" autocomplete="off" name="radio_DYNIONZCWW" value="answer"></input> <span>Quantitative: continuous</span></label><label><input type="radio" autocomplete="off" name="radio_DYNIONZCWW" value=""></input> <span>Qualitative: nominal</span></label><label><input type="radio" autocomplete="off" name="radio_DYNIONZCWW" value=""></input> <span>Qualitative: ordinal</span></label></div>
