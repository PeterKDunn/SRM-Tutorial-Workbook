...
1. The $\text{OR} = 4.1$ and $P = 0.36$. \tightlist 
   <div class='webex-radiogroup' id='radio_OHYRRDFJQT'><label><input type="radio" autocomplete="off" name="radio_OHYRRDFJQT" value=""></input> <span>Consistent with conclusion</span></label><label><input type="radio" autocomplete="off" name="radio_OHYRRDFJQT" value="answer"></input> <span>NOT consistent with conclusion</span></label></div>

2. The $\text{OR} = 4.1$ and $P = 0.0001$.  
   <div class='webex-radiogroup' id='radio_TAVNVKFAUO'><label><input type="radio" autocomplete="off" name="radio_TAVNVKFAUO" value="answer"></input> <span>Consistent with conclusion</span></label><label><input type="radio" autocomplete="off" name="radio_TAVNVKFAUO" value=""></input> <span>NOT consistent with conclusion</span></label></div>

3. The $\text{OR} = 0.91$ and $P = 0.36$.  
   <div class='webex-radiogroup' id='radio_YLPLUOGSFS'><label><input type="radio" autocomplete="off" name="radio_YLPLUOGSFS" value=""></input> <span>Consistent with conclusion</span></label><label><input type="radio" autocomplete="off" name="radio_YLPLUOGSFS" value="answer"></input> <span>NOT consistent with conclusion</span></label></div>

4. The $\text{OR} = 0.91$ and $P = 0.0001$.  
   <div class='webex-radiogroup' id='radio_CPFFPYDMZS'><label><input type="radio" autocomplete="off" name="radio_CPFFPYDMZS" value="answer"></input> <span>Consistent with conclusion</span></label><label><input type="radio" autocomplete="off" name="radio_CPFFPYDMZS" value=""></input> <span>NOT consistent with conclusion</span></label></div>
...
<div class='webex-radiogroup' id='radio_NKSYIUSRGJ'><label><input type="radio" autocomplete="off" name="radio_NKSYIUSRGJ" value="answer"></input> <span>The odds of a person being bitten by a mosquito is the same for people near citronella candles and wax candles</span></label><label><input type="radio" autocomplete="off" name="radio_NKSYIUSRGJ" value=""></input> <span>The proportion of people being bitten by a mosquito is the same for people near citronella candles and wax candles</span></label><label><input type="radio" autocomplete="off" name="radio_NKSYIUSRGJ" value=""></input> <span>Either of the above</span></label></div>
...
<div class='webex-radiogroup' id='radio_ZPODFADRLR'><label><input type="radio" autocomplete="off" name="radio_ZPODFADRLR" value="answer"></input> <span>A CI for the odds ratio</span></label><label><input type="radio" autocomplete="off" name="radio_ZPODFADRLR" value=""></input> <span>A CI for the difference in proportions</span></label><label><input type="radio" autocomplete="off" name="radio_ZPODFADRLR" value=""></input> <span>Either of the above</span></label></div>
...
<div class='webex-radiogroup' id='radio_SNHTXNNNPP'><label><input type="radio" autocomplete="off" name="radio_SNHTXNNNPP" value=""></input> <span>A hypothesis tests for the difference between proportions</span></label><label><input type="radio" autocomplete="off" name="radio_SNHTXNNNPP" value="answer"></input> <span>A hypothesis tests for the odds ratio</span></label><label><input type="radio" autocomplete="off" name="radio_SNHTXNNNPP" value=""></input> <span>Either of the above</span></label></div>
