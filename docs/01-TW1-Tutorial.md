...
1.  What *type* of RQ is this? 
    Explain.\tightlist
<div class='webex-radiogroup' id='radio_TVEVDNXOKF'><label><input type="radio" autocomplete="off" name="radio_TVEVDNXOKF" value=""></input> <span>Descriptive</span></label><label><input type="radio" autocomplete="off" name="radio_TVEVDNXOKF" value="answer"></input> <span>Relational</span></label><label><input type="radio" autocomplete="off" name="radio_TVEVDNXOKF" value=""></input> <span>Repeated-measures</span></label><label><input type="radio" autocomplete="off" name="radio_TVEVDNXOKF" value=""></input> <span>Correlational</span></label></div>

\greyboxlines{1}
2.  What is the *purpose* this RQ? 
    Explain.\tightlist
<div class='webex-radiogroup' id='radio_IKCSXKXTLX'><label><input type="radio" autocomplete="off" name="radio_IKCSXKXTLX" value=""></input> <span>Estimation</span></label><label><input type="radio" autocomplete="off" name="radio_IKCSXKXTLX" value="answer"></input> <span>Decision-making</span></label></div>

\greyboxlines{1}
3. Is an *intervention* present? 
   Explain.\tightlist
<div class='webex-radiogroup' id='radio_HALVJKLCRV'><label><input type="radio" autocomplete="off" name="radio_HALVJKLCRV" value=""></input> <span>Yes</span></label><label><input type="radio" autocomplete="off" name="radio_HALVJKLCRV" value="answer"></input> <span>No</span></label></div>

\greyboxlines{1}
4. What is the *outcome* in this RQ?
   Explain.
<div class='webex-radiogroup' id='radio_KGISHKCRQN'><label><input type="radio" autocomplete="off" name="radio_KGISHKCRQN" value=""></input> <span>The amount of salt in each meal</span></label><label><input type="radio" autocomplete="off" name="radio_KGISHKCRQN" value="answer"></input> <span>The average amount of salt</span></label><label><input type="radio" autocomplete="off" name="radio_KGISHKCRQN" value=""></input> <span>The average amount of salt in Chinese and Indian take-away meals</span></label><label><input type="radio" autocomplete="off" name="radio_KGISHKCRQN" value=""></input> <span>London take-away restaurants</span></label></div>

\greyboxlines{1}
5. What is the *response variable*?
<div class='webex-radiogroup' id='radio_RTRKLXBNGT'><label><input type="radio" autocomplete="off" name="radio_RTRKLXBNGT" value=""></input> <span>The average amount of salt</span></label><label><input type="radio" autocomplete="off" name="radio_RTRKLXBNGT" value="answer"></input> <span>The amount of salt in each meal</span></label><label><input type="radio" autocomplete="off" name="radio_RTRKLXBNGT" value=""></input> <span>The type of London take-away restaurant</span></label></div>

\greyboxlines{1}
6. What is the *unit of analysis*?
   Explain.
<div class='webex-radiogroup' id='radio_NLXDFWAKXT'><label><input type="radio" autocomplete="off" name="radio_NLXDFWAKXT" value=""></input> <span>Each restaurant</span></label><label><input type="radio" autocomplete="off" name="radio_NLXDFWAKXT" value=""></input> <span>Each meal</span></label><label><input type="radio" autocomplete="off" name="radio_NLXDFWAKXT" value="answer"></input> <span>We need more information about how the data were collected</span></label></div>

\greyboxlines{1}
7. What is the *unit of observation*?
   Explain.
<div class='webex-radiogroup' id='radio_FMKNJJXWSJ'><label><input type="radio" autocomplete="off" name="radio_FMKNJJXWSJ" value=""></input> <span>Each restaurant</span></label><label><input type="radio" autocomplete="off" name="radio_FMKNJJXWSJ" value="answer"></input> <span>Each meal</span></label><label><input type="radio" autocomplete="off" name="radio_FMKNJJXWSJ" value=""></input> <span>It&apos;s hard to know: we need more information about how the data were collected</span></label></div>
...
<div class='webex-radiogroup' id='radio_OGLYCENSVM'><label><input type="radio" autocomplete="off" name="radio_OGLYCENSVM" value=""></input> <span>Operational </span></label><label><input type="radio" autocomplete="off" name="radio_OGLYCENSVM" value="answer"></input> <span>Conceptual</span></label></div>
...
## Class discussion {#TW1-Class-Discussion}
...
> While at Café\ C one day enjoying a small, organic, almond-milk, half-strength, decaffeinated latte (sometimes called a *Why-Bother*...), Nim sighed, 'Exams start next week.
