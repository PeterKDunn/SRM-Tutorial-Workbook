...
- Call-outs to **orient** your study in the big picture:
...
- Call-outs to indicate things **to do**:

:::: {.startClassBox .startClass data-latex="{iconmonstr-rocket-20-240.png}"}
These call-outs highlight questions to be completed at the start of each tutorial, as a class.
:::
...
Questions with this icon in the margin (TUTOR VERSIONS ONLY) have MentiMeter availability.
\mentiQuestion 
![icon](icons/iconmnstr-computer-6-240.png){.inline-icon}




- Call-outs that offer **support**:
