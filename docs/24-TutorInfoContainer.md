...
## Tutor guidelines for in-class discussions {#ClassDiscussions .unlisted .unnumbered}
...
\BeginKnitrBlock{rmdTutorInfo}<div class="rmdTutorInfo">The purpose of this question is to get students thinking about *study design* for Assessment Task\ 2A.
...
**Save the protocol!**</div>\EndKnitrBlock{rmdTutorInfo}
...
For your info only (note the means and medians are very similar), see Table\ \@ref(tab:NumericalSummary).</div>\EndKnitrBlock{rmdTutorInfo}


<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:NumericalSummary)(\#tab:NumericalSummary)Some statistics from the graphs</caption>
 <thead>
  <tr>
...
<img src="SoftwareImages/RulerDropData.png" alt="Data entered in jamovi for the ruler-drop study" width="436" />
