...
<img src="Illustrations/raphael-nogueira-Znvxeud6sDc-unsplash.jpg" alt="" width="30%" style="float:right; padding:10px" />
...
<img src="SoftwareImages/LimeTreesSummary.png" alt="jamovi output for comparing DBH (in cm) for two groups of lime trees," width="75%" />
<p class="caption">(\#fig:LimeTreesSummmary)jamovi output for comparing DBH (in cm) for two groups of lime trees,</p>
</div>
...
\answerbox{2}
3. *Suppose* the $95$% CI for the difference was computed as\ $-2.7$ to\ $1.5$: very carefully interpret what this would mean in context.
\answerbox{2}
4. *Suppose* the $95$% CI for the difference was computed as\ $0.6$ to\ $4.0$: very carefully interpret what this would mean in context.
\answerbox{2}
5. *Suppose* the $95$% CI for the difference was computed as\ $-4.5$ to\ $-1.6$: very carefully interpret what this would mean in context.
\answerbox{2}
...
<img src="Illustrations/pexels-shotpot-4046557.jpg" alt="" width="35%" style="float:right; padding:10px" />
...
\answerbox{2}
6. Compute the *changes* in 2MWT for each patient (write them to the right of the table in Fig.\ \@ref(fig:Guirao2MWT)).
...
\answerbox{3}
15. Which of the following is the correct null hypothesis? \tightlist
...
<img src="Illustrations/pexels-alexas-fotos-2189599.jpg" alt="" width="35%" style="float:right; padding:10px" />
