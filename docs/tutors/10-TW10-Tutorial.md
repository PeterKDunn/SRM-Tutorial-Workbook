...
<div class='webex-radiogroup' id='radio_SLWNFSRVPB'><label><input type="radio" autocomplete="off" name="radio_SLWNFSRVPB" value="answer"></input> <span>A CI for the odds ratio</span></label><label><input type="radio" autocomplete="off" name="radio_SLWNFSRVPB" value=""></input> <span>A CI for the difference in proportions</span></label><label><input type="radio" autocomplete="off" name="radio_SLWNFSRVPB" value=""></input> <span>Either of the above</span></label></div>
...
<div class='webex-radiogroup' id='radio_CVAMNWHBTH'><label><input type="radio" autocomplete="off" name="radio_CVAMNWHBTH" value=""></input> <span>A hypothesis tests for the difference between proportions</span></label><label><input type="radio" autocomplete="off" name="radio_CVAMNWHBTH" value="answer"></input> <span>A hypothesis tests for the odds ratio</span></label><label><input type="radio" autocomplete="off" name="radio_CVAMNWHBTH" value=""></input> <span>Either of the above</span></label></div>
