...
<div class='webex-radiogroup' id='radio_CZJPELEPGF'><label><input type="radio" autocomplete="off" name="radio_CZJPELEPGF" value="answer"></input> <span>The odds of a person being bitten by a mosquito is the same for people near citronella candles and wax candles</span></label><label><input type="radio" autocomplete="off" name="radio_CZJPELEPGF" value=""></input> <span>The proportion of people being bitten by a mosquito is the same for people near citronella candles and wax candles</span></label><label><input type="radio" autocomplete="off" name="radio_CZJPELEPGF" value=""></input> <span>Either of the above</span></label></div>
...
<div class='webex-radiogroup' id='radio_WYQKTIKEBM'><label><input type="radio" autocomplete="off" name="radio_WYQKTIKEBM" value="answer"></input> <span>A CI for the odds ratio</span></label><label><input type="radio" autocomplete="off" name="radio_WYQKTIKEBM" value=""></input> <span>A CI for the difference in proportions</span></label><label><input type="radio" autocomplete="off" name="radio_WYQKTIKEBM" value=""></input> <span>Either of the above</span></label></div>
...
<div class='webex-radiogroup' id='radio_OOXAGTHEZW'><label><input type="radio" autocomplete="off" name="radio_OOXAGTHEZW" value=""></input> <span>A hypothesis tests for the difference between proportions</span></label><label><input type="radio" autocomplete="off" name="radio_OOXAGTHEZW" value="answer"></input> <span>A hypothesis tests for the odds ratio</span></label><label><input type="radio" autocomplete="off" name="radio_OOXAGTHEZW" value=""></input> <span>Either of the above</span></label></div>
