...
<div class='webex-radiogroup' id='radio_HKRBYILYUJ'><label><input type="radio" autocomplete="off" name="radio_HKRBYILYUJ" value="answer"></input> <span>The odds of a person being bitten by a mosquito is the same for people near citronella candles and wax candles</span></label><label><input type="radio" autocomplete="off" name="radio_HKRBYILYUJ" value=""></input> <span>The proportion of people being bitten by a mosquito is the same for people near citronella candles and wax candles</span></label><label><input type="radio" autocomplete="off" name="radio_HKRBYILYUJ" value=""></input> <span>Either of the above</span></label></div>
...
<div class='webex-radiogroup' id='radio_NSOMQYXRHC'><label><input type="radio" autocomplete="off" name="radio_NSOMQYXRHC" value="answer"></input> <span>A CI for the odds ratio</span></label><label><input type="radio" autocomplete="off" name="radio_NSOMQYXRHC" value=""></input> <span>A CI for the difference in proportions</span></label><label><input type="radio" autocomplete="off" name="radio_NSOMQYXRHC" value=""></input> <span>Either of the above</span></label></div>
