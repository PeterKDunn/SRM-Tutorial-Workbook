...
2. *Correct*: There is no evidence that the population proportion of students using AI daily is not\ $0.40$, as claimed. 
...
3. *Correct*: There is evidence that the population proportion of students using AI daily is not\ $0.40$%.
