...
<div class='webex-radiogroup' id='radio_HELRTSJRTB'><label><input type="radio" autocomplete="off" name="radio_HELRTSJRTB" value="answer"></input> <span>0.391</span></label><label><input type="radio" autocomplete="off" name="radio_HELRTSJRTB" value=""></input> <span>0.609</span></label><label><input type="radio" autocomplete="off" name="radio_HELRTSJRTB" value=""></input> <span>0.524</span></label><label><input type="radio" autocomplete="off" name="radio_HELRTSJRTB" value=""></input> <span>0.333</span></label></div>

\greyboxlines{2}
5. Of the *female* patients, what *proportion*  had their stroke symptoms missed by the dispatcher?
<div class='webex-radiogroup' id='radio_BMMHBNUGEX'><label><input type="radio" autocomplete="off" name="radio_BMMHBNUGEX" value=""></input> <span>0.713</span></label><label><input type="radio" autocomplete="off" name="radio_BMMHBNUGEX" value=""></input> <span>0.476</span></label><label><input type="radio" autocomplete="off" name="radio_BMMHBNUGEX" value="answer"></input> <span>0.287</span></label><label><input type="radio" autocomplete="off" name="radio_BMMHBNUGEX" value=""></input> <span>0.333</span></label></div>

\greyboxlines{2}
6. For the *male* patients, what are the *odds* that they had their stroke symptoms missed by the dispatcher?
<div class='webex-radiogroup' id='radio_BIYNDWMHUT'><label><input type="radio" autocomplete="off" name="radio_BIYNDWMHUT" value=""></input> <span>39.1</span></label><label><input type="radio" autocomplete="off" name="radio_BIYNDWMHUT" value="answer"></input> <span>0.642</span></label><label><input type="radio" autocomplete="off" name="radio_BIYNDWMHUT" value=""></input> <span>0.907</span></label><label><input type="radio" autocomplete="off" name="radio_BIYNDWMHUT" value=""></input> <span>0.50</span></label></div>

\greyboxlines{2}
7. For the *female* patients, what are the *odds* that they had their stroke symptoms missed by the dispatcher?
<div class='webex-radiogroup' id='radio_DOYWQVDLFF'><label><input type="radio" autocomplete="off" name="radio_DOYWQVDLFF" value="answer"></input> <span>0.402</span></label><label><input type="radio" autocomplete="off" name="radio_DOYWQVDLFF" value=""></input> <span>2.49</span></label><label><input type="radio" autocomplete="off" name="radio_DOYWQVDLFF" value=""></input> <span>1.10</span></label><label><input type="radio" autocomplete="off" name="radio_DOYWQVDLFF" value=""></input> <span>1.24</span></label></div>
...
<div class='webex-radiogroup' id='radio_UROWMGJERQ'><label><input type="radio" autocomplete="off" name="radio_UROWMGJERQ" value=""></input> <span>0.391</span></label><label><input type="radio" autocomplete="off" name="radio_UROWMGJERQ" value=""></input> <span>1.6</span></label><label><input type="radio" autocomplete="off" name="radio_UROWMGJERQ" value="answer"></input> <span>0.104</span></label><label><input type="radio" autocomplete="off" name="radio_UROWMGJERQ" value=""></input> <span>0.287</span></label></div>

\greyboxlines{2}
9. What is the *odds ratio* that a patients had their stroke symptoms missed by the dispatcher, comparing *males* to *females*?
<div class='webex-radiogroup' id='radio_ZEPRIQFMGT'><label><input type="radio" autocomplete="off" name="radio_ZEPRIQFMGT" value=""></input> <span>0.63</span></label><label><input type="radio" autocomplete="off" name="radio_ZEPRIQFMGT" value=""></input> <span>0.402</span></label><label><input type="radio" autocomplete="off" name="radio_ZEPRIQFMGT" value=""></input> <span>0.50</span></label><label><input type="radio" autocomplete="off" name="radio_ZEPRIQFMGT" value="answer"></input> <span>1.6</span></label></div>
