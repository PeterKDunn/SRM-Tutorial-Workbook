...
<div class='webex-radiogroup' id='radio_YDDFWOXUFJ'><label><input type="radio" autocomplete="off" name="radio_YDDFWOXUFJ" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_YDDFWOXUFJ" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_YDDFWOXUFJ" value=""></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
2. The probability that a given Nambour resident is a UniSC student.
<div class='webex-radiogroup' id='radio_LERIVMLVJK'><label><input type="radio" autocomplete="off" name="radio_LERIVMLVJK" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_LERIVMLVJK" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_LERIVMLVJK" value=""></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
3. The probability that Labor wins the next federal election.
<div class='webex-radiogroup' id='radio_URVCUHCABO'><label><input type="radio" autocomplete="off" name="radio_URVCUHCABO" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_URVCUHCABO" value=""></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_URVCUHCABO" value="answer"></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
4. The probability that you will throw a dart and hit the bullseye.
<div class='webex-radiogroup' id='radio_YPXEUZMJFC'><label><input type="radio" autocomplete="off" name="radio_YPXEUZMJFC" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_YPXEUZMJFC" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_YPXEUZMJFC" value=""></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
5. The probability that a roulette wheel spins a $33$.
<div class='webex-radiogroup' id='radio_DPCQQCXFVC'><label><input type="radio" autocomplete="off" name="radio_DPCQQCXFVC" value="answer"></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_DPCQQCXFVC" value=""></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_DPCQQCXFVC" value=""></input> <span>Subjective approach.</span></label></div>
