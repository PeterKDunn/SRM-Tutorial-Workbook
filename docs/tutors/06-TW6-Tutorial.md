...
<div class='webex-radiogroup' id='radio_BHUGRYSKMY'><label><input type="radio" autocomplete="off" name="radio_BHUGRYSKMY" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_BHUGRYSKMY" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_BHUGRYSKMY" value=""></input> <span>Subjective approach.</span></label></div>

\answerbox{1}
2. The probability that a given Nambour resident is a UniSC student.
<div class='webex-radiogroup' id='radio_ENBGSAFFWT'><label><input type="radio" autocomplete="off" name="radio_ENBGSAFFWT" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_ENBGSAFFWT" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_ENBGSAFFWT" value=""></input> <span>Subjective approach.</span></label></div>

\answerbox{1}
3. The probability that Labor wins the next federal election.
<div class='webex-radiogroup' id='radio_MBXZUZQCOM'><label><input type="radio" autocomplete="off" name="radio_MBXZUZQCOM" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_MBXZUZQCOM" value=""></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_MBXZUZQCOM" value="answer"></input> <span>Subjective approach.</span></label></div>

\answerbox{1}
4. The probability that you will throw a dart and hit the bullseye.
<div class='webex-radiogroup' id='radio_ZMNHVJOBRV'><label><input type="radio" autocomplete="off" name="radio_ZMNHVJOBRV" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_ZMNHVJOBRV" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_ZMNHVJOBRV" value=""></input> <span>Subjective approach.</span></label></div>

\answerbox{1}
5. The probability that a roulette wheel spins a $33$.
<div class='webex-radiogroup' id='radio_UTKXUWBIEO'><label><input type="radio" autocomplete="off" name="radio_UTKXUWBIEO" value="answer"></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_UTKXUWBIEO" value=""></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_UTKXUWBIEO" value=""></input> <span>Subjective approach.</span></label></div>
...
<div class="figure" style="text-align: center">
<img src="06-TW6-Tutorial_files/figure-html/HistCoinToss-1.png" alt="The histogram of the proportion of heads in $10$ tosses, for $400$ repetitions." width="70%" />
