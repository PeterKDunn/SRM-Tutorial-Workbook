...
<select class='webex-select'><option value='blank'></option><option value=''>1.77</option><option value='answer'>-1.77</option><option value=''>-0.7</option><option value=''>0.7</option></select>
\greyboxlines{2}
1. What is the $z$-score for the heaviest truck of $26.0$\ tonnes?
<select class='webex-select'><option value='blank'></option><option value='answer'>10</option><option value=''>-10</option><option value=''>-16</option><option value=''>16</option></select>
\greyboxlines{2}
1. What does a *negative* $z$-score mean in this context?
<select class='webex-select'><option value='blank'></option><option value=''>There has been an error</option><option value=''>The mass is larger than average</option><option value='answer'>The mass is lower than average</option><option value=''>The mass is a negative number, which is impossible</option></select>
\greyboxlines{2}
1. **True** or **false**:
...
<div class='webex-radiogroup' id='radio_MYSGCTVGBA'><label><input type="radio" autocomplete="off" name="radio_MYSGCTVGBA" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_MYSGCTVGBA" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_MYSGCTVGBA" value=""></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
2. The probability that a given Nambour resident is a UniSC student.
<div class='webex-radiogroup' id='radio_IWTMCTXDOH'><label><input type="radio" autocomplete="off" name="radio_IWTMCTXDOH" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_IWTMCTXDOH" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_IWTMCTXDOH" value=""></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
3. The probability that Labor wins the next federal election.
<div class='webex-radiogroup' id='radio_RTKNLMNUGL'><label><input type="radio" autocomplete="off" name="radio_RTKNLMNUGL" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_RTKNLMNUGL" value=""></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_RTKNLMNUGL" value="answer"></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
4. The probability that you will throw a dart and hit the bullseye.
<div class='webex-radiogroup' id='radio_MDOZRFHRDM'><label><input type="radio" autocomplete="off" name="radio_MDOZRFHRDM" value=""></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_MDOZRFHRDM" value="answer"></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_MDOZRFHRDM" value=""></input> <span>Subjective approach.</span></label></div>

\greyboxlines{1}
5. The probability that a roulette wheel spins a $33$.
<div class='webex-radiogroup' id='radio_EZNATRNGBY'><label><input type="radio" autocomplete="off" name="radio_EZNATRNGBY" value="answer"></input> <span>Classical approach.</span></label><label><input type="radio" autocomplete="off" name="radio_EZNATRNGBY" value=""></input> <span>Relative frequency approach.</span></label><label><input type="radio" autocomplete="off" name="radio_EZNATRNGBY" value=""></input> <span>Subjective approach.</span></label></div>
